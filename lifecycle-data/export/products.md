...
ms.locfileid: "903660"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="c03ad-103">수명 주기 데이터 내보내기</span><span class="sxs-lookup"><span data-stu-id="c03ad-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="c03ad-104">이 페이지는 현재 개발 중입니다.</span><span class="sxs-lookup"><span data-stu-id="c03ad-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="c03ad-105">모든 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="c03ad-105">Export all products</span></span>
<span data-ttu-id="c03ad-106">아래를 클릭하여 모든 제품에 대한 수명 주기 데이터를 내보냅니다.</span><span class="sxs-lookup"><span data-stu-id="c03ad-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="c03ad-107">모든 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="c03ad-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="c03ad-108">제품군 및 그룹별로 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="c03ad-108">Export products by Family and Group</span></span>
<span data-ttu-id="c03ad-109">가족과 그룹을 선택하여 내보낼 그룹을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="c03ad-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="c03ad-110">참고: 그룹 값이 선택된 시기에 내보내기가 시작됩니다.</span><span class="sxs-lookup"><span data-stu-id="c03ad-110">Note: Export will begin when Group value is selected.</span></span> 
...
> - [(Azure | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Azure')
...
> - [(Azure | 기타)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Azure'%20and%20parent/parent/name%20eq%20'Other')
> - [(Dynamics | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Dynamics')
> - [(Dynamics | 역동성)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Dynamics'%20and%20parent/parent/name%20eq%20'Dynamics')
...
> - [(Dynamics | 기타)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Dynamics'%20and%20parent/parent/name%20eq%20'Other')
> - [(식 | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Expression')
...
> - [(Microsoft 365 | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20365')
...
> - [(Microsoft 365 | Identity Management(ID 관리)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20365'%20and%20parent/parent/name%20eq%20'Identity%20Management')
> - [(Microsoft 연결된 서비스 프레임워크 | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Connected%20Services%20Framework')
...
> - [(Microsoft Office | 보안)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Office'%20and%20parent/parent/name%20eq%20'Security')
...
> - [(Microsoft Servers | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Servers')
...
> - [(Microsoft Servers | 보안)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Servers'%20and%20parent/parent/name%20eq%20'Security')
> - [(Microsoft System Center | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20System%20Center')
...
> - [(Silverlight | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Silverlight')
...
> - [(SQL Server | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'SQL%20Server')
...
> - [(Visual Studio | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Visual%20Studio')
...
> - [(Windows | 모두)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Windows')
...
> - [(Windows | 모바일)](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Windows'%20and%20parent/parent/name%20eq%20'Mobile')
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="c03ad-169">지원 날짜의 종료 날짜별로 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="c03ad-169">Export products by end of support date</span></span>
<span data-ttu-id="c03ad-170">1년을 선택하여 지원 종료에 도달하는 제품을 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="c03ad-170">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="c03ad-171">참고: 연도 값을 선택한 시기에 내보내기가 시작됩니다.</span><span class="sxs-lookup"><span data-stu-id="c03ad-171">Note: Export will begin when Year value is selected.</span></span>
