...
아래를 클릭하여 모든 제품에 대한 수명 주기 데이터를 내보냅니다.
...
가족과 그룹을 선택하여 내보낼 그룹을 선택합니다. 참고: 그룹 값이 선택된 시기에 내보내기가 시작됩니다. 
...
## <a name="export-products-by-end-of-support-date"></a>지원 날짜의 종료 날짜별로 제품 내보내기
1년을 선택하여 지원 종료에 도달하는 제품을 확인하세요. 참고: 연도 값을 선택한 시기에 내보내기가 시작됩니다.
