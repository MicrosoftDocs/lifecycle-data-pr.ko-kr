...
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="db1ad-103">수명 주기 데이터 내보내기</span><span class="sxs-lookup"><span data-stu-id="db1ad-103">Lifecycle data export</span></span>

## <a name="export-all-products"></a><span data-ttu-id="db1ad-104">모든 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="db1ad-104">Export all products</span></span>
<span data-ttu-id="db1ad-105">아래를 클릭하여 모든 제품에 대한 수명 주기 데이터를 내보냅니다.</span><span class="sxs-lookup"><span data-stu-id="db1ad-105">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="db1ad-106">모든 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="db1ad-106">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="db1ad-107">제품군 및 그룹별 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="db1ad-107">Export products by Family and Group</span></span>
<span data-ttu-id="db1ad-108">내보내려면 제품군을 선택한 다음 그룹을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="db1ad-108">Select a Family and then a Group to export.</span></span> <span data-ttu-id="db1ad-109">참고: 그룹 값을 선택하면 내보내기가 시작됩니다.</span><span class="sxs-lookup"><span data-stu-id="db1ad-109">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="db1ad-170">지원 종료일별 제품 내보내기</span><span class="sxs-lookup"><span data-stu-id="db1ad-170">Export products by end of support date</span></span>
<span data-ttu-id="db1ad-171">지원이 종료되는 제품을 보려면 연도를 선택하세요.</span><span class="sxs-lookup"><span data-stu-id="db1ad-171">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="db1ad-172">참고: 연도 값을 선택하면 내보내기가 시작됩니다.</span><span class="sxs-lookup"><span data-stu-id="db1ad-172">Note: Export will begin when Year value is selected.</span></span>
